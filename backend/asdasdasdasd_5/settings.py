"""
Django settings for asdasdasdasd_5 project.
...
ROOT_URLCONF = 'asdasdasdasd_5.urls'
...
WSGI_APPLICATION = 'asdasdasdasd_5.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "asdasdasdasd_5 API",
    "DESCRIPTION": "API documentation for asdasdasdasd_5 App",
    "VERSION": "v1",
}
